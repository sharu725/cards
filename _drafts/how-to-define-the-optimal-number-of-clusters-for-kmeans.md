...
This dataset holds 150 samples of three Iris species (_Iris setosa, Iris virginica_ and _Iris versicolor_) that even though are very similar,  are distinguishable using a model developed by the biologist and statistician Ronald Fisher.
